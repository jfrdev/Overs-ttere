...
struct
  ...
  fun compileExp e vtable ftable place =
      case e of
        S100.NumConst (n,pos) =>
        if n<32768
        then (Type.Int,[Mips.LI (place, makeConst n)])
        else
          (Type.Int,
  ...
  fun compile funs =
      ...
      in
        ...
        @ [Mips.LABEL "putint",     (* putint function *)
           ...
           Mips.SUB (HP , HP , "2"),(* træk det fra HP *)
           ...
           Mips.SUB (HP , HP , "2"),(* træk argumentet fra HP *)
